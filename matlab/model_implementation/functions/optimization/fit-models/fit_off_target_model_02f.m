function [x, fx] = fit_off_target_model_02f(seed, substrate, alpha, on_target_pset)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-02f.json');
...
output_folder = "../output/fits/off-target/model-02f/sub_"+num2str(substrate)+"/"+"alpha_"+num2str(alpha)+"/";
