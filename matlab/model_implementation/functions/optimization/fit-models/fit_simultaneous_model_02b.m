function [x, fx] = fit_simultaneous_model_02b(seed, alpha)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-02b.json');
...
output_folder = "../output/fits/simultaneous/model-02b/sub_48/"+"alpha_"+num2str(alpha)+"/";
