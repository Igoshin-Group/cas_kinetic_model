function [x, fx] = fit_simultaneous_model_04(seed, alpha)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-04.json');
...
output_folder = "../output/fits/simultaneous/model-04/sub-05/"+"alpha_"+num2str(alpha)+"/";
