function [x, fx] = fit_simultaneous_model_03(seed, alpha)
...
off_idx = [5]; % indices of off-target substrates for fitting (substrate 48 has 4bp distal mismatch)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-03.json');
...
output_folder = "../output/fits/simultaneous/model-03/sub-05/"+"alpha_"+num2str(alpha)+"/";
