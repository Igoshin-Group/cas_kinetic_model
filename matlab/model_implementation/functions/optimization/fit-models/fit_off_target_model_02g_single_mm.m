function [x, fx] = fit_off_target_model_02g_single_mm(seed, substrate, alpha, on_target_pset)

% load and pre-process data for fitting
dataset = load_all_data(inf);
...
output_folder = "../output/fits/off-target-smm/model-02g/sub_"+num2str(substrate)+"/"+"alpha_"+num2str(alpha)+"/";
...
fitting_options.state_occupancy = false;
fitting_options.dwell_mean = false;
fitting_options.dwell_variance = false;
fitting_options.dwell_cv = false;
