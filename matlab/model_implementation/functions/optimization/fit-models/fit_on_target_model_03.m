function [x, fx] = fit_on_target_model_03(seed)
...
base_model = load_model('../models/on_target_model_03.json');
...
output_folder = '../output/on_target_model_fits/model_03/variability/';
