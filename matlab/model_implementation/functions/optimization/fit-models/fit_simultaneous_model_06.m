function [x, fx] = fit_simultaneous_model_06(seed, alpha)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-06.json');
...
output_folder = "../output/fits/simultaneous/model-06/sub_48/"+"alpha_"+num2str(alpha)+"/";
