function [x, fx] = fit_simultaneous_model_02f(seed, substrate, alpha)
...
output_folder = "../output/fits/simultaneous/model-02f/sub_"+num2str(substrate)+"/"+"alpha_"+num2str(alpha)+"/";
