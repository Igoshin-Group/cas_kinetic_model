function [x, fx] = fit_on_target_model_02(seed)
...
base_model = load_model('../models/on_target_model_02.json');
...
output_folder = '../output/on_target_model_fits/model_02/variability/';
