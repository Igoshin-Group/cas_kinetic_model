function [x, fx] = fit_simultaneous_model_02c(seed, substrate, alpha)
...
output_folder = "../output/fits/simultaneous/model-02c/corrected-mfpt/sub_"+num2str(substrate)+"/"+"alpha_"+num2str(alpha)+"/";
