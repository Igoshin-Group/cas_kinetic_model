function [x, fx] = fit_off_target_model_02g(seed, substrate, alpha, on_target_pset)
...
output_folder = "../output/fits/off-target/model-02g/sub_"+num2str(substrate)+"/"+"alpha_"+num2str(alpha)+"/";
