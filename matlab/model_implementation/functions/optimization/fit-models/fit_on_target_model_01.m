function [x, fx] = fit_on_target_model(seed)
...
base_model = load_model('../models/on_target_model_01.json');
...
output_folder = '../output/on_target_model_fits/model_01/prime/variability/qualitative_penalty/';
