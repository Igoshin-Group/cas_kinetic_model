function [x, fx] = fit_simultaneous_model_01(seed, alpha)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-01.json');
...
output_folder = "../output/fits/simultaneous/model-01/"+"alpha_"+num2str(alpha)+"/";
