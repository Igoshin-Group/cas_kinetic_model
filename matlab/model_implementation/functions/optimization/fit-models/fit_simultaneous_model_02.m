function [x, fx] = fit_simultaneous_model_02(seed, alpha)
...
% load the model
base_model = load_model('../models/simultaneous/cas-simultaneous-model-02.json');
...
output_folder = "../output/fits/simultaneous/model-02/low_conc/sub_48/"+"alpha_"+num2str(alpha)+"/";
