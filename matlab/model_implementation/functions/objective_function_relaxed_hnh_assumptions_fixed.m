function s = objective_function_relaxed_hnh_assumptions_fixed(x, on_data, off_data)
...
%   off_data = off-target substrate data (Mx1 struct array)
    ...
    [model, energies] = generate_model_from_energies(x, C);
...
%     
    ...
    % =================================================================================================    
    for ii = 1:2 % iterate over WT and HF1 parameter sets
