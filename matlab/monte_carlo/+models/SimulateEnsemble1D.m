function traces = SimulateEnsemble1D(t0, tf, S0, model, N, seed)
% SimulateEnsemble1D: simulate an N-member ensemble of traces
%   traces = SimulateEnsemble1D(t0, tf, S0, model, N)
% inputs:
